    ...
    tabPanel("Model",
             ...
             fluidRow(
               column(
                 ...
                 p("For more information, please see ",em("Wang et al. (2021)"),
                   br(),
                   a(href="https://pubs.acs.org/doi/full/10.1021/acsabm.1c00779", "Here",target="_blank",style = "color: blue;"),style="text-align:center;color:black"),
                 br(),
                 br(),
                 br(),
